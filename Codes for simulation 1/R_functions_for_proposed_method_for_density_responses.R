                ...
                ,max_cbs_iteration=20,cv=10,h_add=NULL,h_length=NULL)
{
  ...
  result=.Fortran('CBS_continuous_density',n=n,d=d,T=T,X_training=X_training,Y_training=Y_training,
                  h_vector=h_candidate_matrix,add=add,max_iteration=max_iteration,epsilon=epsilon,time_vector=Y_grid,
